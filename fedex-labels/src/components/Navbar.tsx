    ...
    <nav style={{
      ...
      <div style={{ maxWidth: 1120, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 64 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }} className="desktop-nav">
          <a href="#pricing" style={{ color: 'var(--text-muted)', textDecoration: 'none', padding: '6px 14px', fontSize: 14, fontWeight: 500 }}>
            Pricing
          </a>
          <a href="#how-it-works" style={{ color: 'var(--text-muted)', textDecoration: 'none', padding: '6px 14px', fontSize: 14, fontWeight: 500 }}>
            How it works
          </a>
          {user ? (
